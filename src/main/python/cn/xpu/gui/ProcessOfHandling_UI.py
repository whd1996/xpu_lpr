...
class App(ttk.Frame):
    ...
    def __init__(self, win):
        ...
        self.image_1.pack()
        self.image_11 = ttk.Label(frame_1, text='灰度变化', font=('微软雅黑', '14'))
        self.image_11.pack()

        self.image_2 = ttk.Label(frame_2)
        self.image_2.pack()
        self.image_22 = ttk.Label(frame_2, text='边缘检测', font=('微软雅黑', '14'))
        self.image_22.pack()

        self.image_3 = ttk.Label(frame_3)
        self.image_3.pack()
        self.image_33 = ttk.Label(frame_3, text='形态学处理', font=('微软雅黑', '14'))
        self.image_33.pack()

        self.image_4 = ttk.Label(frame_4)
        self.image_4.pack()
        self.image_44 = ttk.Label(frame_4, text='车牌定位', font=('微软雅黑', '14'))
        self.image_44.pack()
        ...
        self.image_5_8 = ttk.Label(frame_5222, text='字符分割', font=('微软雅黑', '14'))
        self.image_5_8.pack()
        ...
        self.init_handle_img()
    def get_imgtk(self, img_bgr):
        img = cv2.cvtColor(img_bgr, cv2.COLOR_BGR2RGB)
        im = Image.fromarray(img)
        pil_image_resized = im.resize((250, 170), Image.LANCZOS)
    ...
    def close_window(self):
        uu = ['src/main/tmp/' + i for i in os.listdir('src/main/tmp/')]
        for i in uu:
            os.remove(i)
        print("destroy")
        root.destroy()
